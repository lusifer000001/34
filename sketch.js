...
var mt_star , starone ,startwo ;
var star_display , star1 , star2 ;
var blower ;
var star ;
...
function setup() 
{
  ...
  star1 = createSprite(250,30,10,10) ;
  star1.addImage(star) ;
  star1.scale = 0.02 ;

  star2 = createSprite(60,300,10,10) ;
  star2.addImage(star) ;
  star2.scale = 0.02 ;

  star_display = createSprite(50,20,30,30) ;
  star_display.scale = 0.2 ;
  star_display.addAnimation("mt",mt_star) ;
  star_display.addAnimation("one",starone) ;
  star_display.addAnimation("two",startwo) ;
  star_display.changeAnimation("mt") ;

  // blower ;
  blower = createImg("baloon2.png") ;
  blower.position(280,450) ;
  blower.size(100,100) ;
